...
// CCDIToken with Governance. Cashcowdefi Finance
contract CCDIToken is BEP20("test Token", "CCDI") {
    // Burn address
    ...
    constructor() public payable {
        // mint 2 CCDI to owner for publicity
    ...
    /// @dev overrides transfer function to meet tokenomics of  CCDI
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, " CCDI::transfer: Burn value invalid");
